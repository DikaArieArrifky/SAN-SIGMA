                ...
                <form action="uploadPhoto" method="post" enctype="multipart/form-data" class="profile-content">
                    <div class="profile-header">
                        ...
                        <img alt="Profile Picture" height="80"
                            src="<?= ($data['dosen']['photo']) ? IMG . '/person/' . $data['dosen']['photo'] : 'https://api.dicebear.com/6.x/avataaars/svg?seed=' . rand() ?>"
                    ...
                    <div class="profile-content">
                        ...
                        <div class="profile-form ">
                            <label for="nama-dosen">
                                Nama dosen
                            </label>
                            <input id="nama-dosen" readonly="" type="text" value="<?= $data['dosen']['name'] ?>">

                            <label for="nip">
                                NIP
                            </label>
                            <input id="nip" readonly="" type="text" value="<?= $data['dosen']['nip'] ?>">

                            <label for="nip">
                                Prodi Home Base
                            </label>
                            <input id="prodi" readonly="" type="text" value="<?= $data['dosen']['prodi'] ?>">

                            <label for="gender">
                                Jenis Kelamin
                            </label>
                            <input id="gender" readonly="" type="text" value="<?= ($data['dosen']['gender'] ?? '') === 'L' ? 'Laki-Laki' : 'Perempuan' ?>">

                            <label for="status">
                                Status
                            </label>
                            <input id="status" readonly="" type="text" value="<?= ($data['dosen']['status'] ?? '') === 'aktif' ? 'dosen Aktif' : 'dosen Tidak Aktif' ?>">

                            <label for="">
                                Alamat
                            </label>
                            <input id="alamat" readonly="" type="text" value="<?= htmlspecialchars($data['dosen']['alamat'] ?? '') ?>">
                            <label for="kota">
                                Kota
                            </label>
                            <input id="kota" readonly="" type="text" value="<?= htmlspecialchars($data['dosen']['kota'] ?? '') ?>">
                            <label for="provinsi">
                                Provinsi
                            </label>
                            <input id="provinsi" readonly="" type="text" value="<?= htmlspecialchars($data['dosen']['provinsi'] ?? '') ?>">
                            ...
                            <input id="agama" readonly="" type="text" value="<?= htmlspecialchars($data['dosen']['agama'] ?? '') ?>">
                            <label for="skor">
                                Skor
                            </label>
                            <input id="skor" readonly="" type="text" value="<?= htmlspecialchars($data['dosen']['score'] ?? '') ?>">
                        </div>
                    </div>
            </div>
        </div>
